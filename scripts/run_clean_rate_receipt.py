...
from src.cleaning.clean_rate_receipt import (
    YEAR_SKIP_MAPPING, 
    merge_columns, 
    unified_map, 
    flat_lookup, 
...
final_panel = create_removal_rate_panel(disposal_long_df, charity_df)

# Step 10: Export final dataset
final_panel.to_csv("data/processed/rate_panel_data.csv", index=False)

print("Final panel dataset saved to data/processed/rate_panel_data.csv")